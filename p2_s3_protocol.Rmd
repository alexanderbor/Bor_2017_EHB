...
2. Whether priming leader evaluation psychology increases the extent of encoding. 
...
Participants were randomly assigned by Qualtrics to a control group (peer prime, essentially a replication of Study 2) or a treatment group (leader prime). 
...
pander(t.test(data$catscore[data$treat == "Lead prime"]))
