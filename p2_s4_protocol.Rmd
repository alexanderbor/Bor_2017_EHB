...
rawdata <- import("https://raw.githubusercontent.com/alexanderbor/paper2/master/P2_S4.csv", na = "", fread = F) 
```
...
pretest <- import("https://raw.githubusercontent.com/alexanderbor/paper2/master/P2_S4_pre.csv", na = "", fread = F)
...
cat("is the categorization score significantly different from 0 in the whole sample?")
...
cat("is the categorization score significantly different from 0 in the peer prime group?")
...
cat("is the categorization score significantly different from 0 in the leader prime group?")
...
cat("Does the treatment increase categorization?")
