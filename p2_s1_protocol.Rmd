---
title: "Paper 2 - Study 1 experimental report"
...
library(rio)
library(tidyr)
# rawdata <- import("https://raw.githubusercontent.com/alexanderbor/paper2/master/P2_S1.csv", na = "", check.names=TRUE) 
# 
# names(rawdata) <- gsub(x = names(rawdata),
#                         pattern = "\\-",
#                         replacement = ".")

rawdata <- import("https://raw.githubusercontent.com/alexanderbor/paper2/master/P2_S1.csv", na = "", fread = F) 
...
print("is the categorization score significantly different from 0?")
t.test(data$catscore)

#calculate effect size (r) from t statistic and df
# sqrt(0.29^2 / (0.29^2 + 153))
...
print("Is there a significant difference in competence ratings?")
t.test(data$compdif)

print("Is there a significant difference in desirability as teammate?")
t.test(data$teamdif)
...
- Replication data set is available through https://raw.githubusercontent.com/alexanderbor/paper2/master/P2_S1.csv
